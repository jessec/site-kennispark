/* File Created: September 2, 2012 */
        ...
        function drawVisualization() {
            ...
            var query =
            new google.visualization.Query('https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdEw1RVQtNGFEYWdJZHhHejJxVm04Rmc');
            ...
            function handleQueryResponse(response) {
                ...
                function drawToolbar() {
                    var components = [
                        { type: 'html', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdEw1RVQtNGFEYWdJZHhHejJxVm04Rmc' },
                        { type: 'csv', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdEw1RVQtNGFEYWdJZHhHejJxVm04Rmc' },
                        {
                            type: 'htmlcode', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdEw1RVQtNGFEYWdJZHhHejJxVm04Rmc',
                        }
                    ];
            ...
            dashboard.bind(categoryPicker, piechart).draw(data);
            dashboard.bind(stringFilter, piechart).draw(data);
            drawToolbar();
            ...
            function dashboardReady() {
                ...
                document.getElementById('btnBigger').onclick = function () {
                    piechart.setOption('width', 900);
                    piechart.setOption('height', 500);
                    piechart.draw();
                };
