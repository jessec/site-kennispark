/* File Created: September 2, 2012 */
        ...
        function drawVisualization() {
            ...
            var query =
            new google.visualization.Query('https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdFJWXzNjaXc2WEIzQ1E3Y290dHRTNEE');
            ...
            function handleQueryResponse(response) {
                ...
                function drawToolbar() {
                    var components = [
                        { type: 'html', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdFJWXzNjaXc2WEIzQ1E3Y290dHRTNEE' },
                        { type: 'csv', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdFJWXzNjaXc2WEIzQ1E3Y290dHRTNEE' },
                        {
                            type: 'htmlcode', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdFJWXzNjaXc2WEIzQ1E3Y290dHRTNEE',
                        }
                    ];
            ...
            var orgchart = new google.visualization.ChartWrapper({
                ...
                'options': {
                    ...
                    'title': "How did you spend your day?",
                    'legend': 'bottom',
            ...
            // Draw the dashboard.
            dashboard.bind(categoryPicker, orgchart).draw(data);
            dashboard.bind(stringFilter, orgchart).draw(data);
            drawToolbar();
            ...
            function dashboardReady() {
                ...
                document.getElementById('btnBigger').onclick = function () {
                    orgchart.setOption('width', 900);
                    orgchart.setOption('height', 500);
                    orgchart.draw();
                };
