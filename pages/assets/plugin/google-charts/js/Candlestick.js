/* File Created: September 2, 2012 */
        ...
        function drawVisualization() {
            ...
            var query =
            new google.visualization.Query('https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdHZwNUhMSVN3bU5TWTZxSWtWRG1lMnc');
            ...
            function handleQueryResponse(response) {
                ...
                function drawToolbar() {
                    var components = [
                        { type: 'html', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdHZwNUhMSVN3bU5TWTZxSWtWRG1lMnc' },
                        { type: 'csv', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdHZwNUhMSVN3bU5TWTZxSWtWRG1lMnc' },
                        {
                            type: 'htmlcode', datasource: 'https://docs.google.com/spreadsheet/ccc?key=0AkDJgEzvX6DDdHZwNUhMSVN3bU5TWTZxSWtWRG1lMnc',
                        }
                    ];
            ...
            // Draw the dashboard.
            dashboard.bind(slider, candlestickchart).draw(data);
            dashboard.bind(categoryPicker, candlestickchart).draw(data);
            dashboard.bind(stringFilter, candlestickchart).draw(data);
            drawToolbar();
            ...
            function dashboardReady() {
                ...
                document.getElementById('btnBigger').onclick = function () {
                    candlestickchart.setOption('width', 900);
                    candlestickchart.setOption('height', 500);
